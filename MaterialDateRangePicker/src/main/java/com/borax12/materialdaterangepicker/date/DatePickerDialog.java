...
public class DatePickerDialog extends DialogFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            for (int i = 0; i < widget.getChildCount(); i++) {
                ...
                d.setColorFilter(getAccentColor(), PorterDuff.Mode.SRC_IN);
        ...
        if (mAccentColor != -1) {
            ...
            view.findViewById(R.id.day_picker_selected_date_layout).setBackgroundColor(mAccentColorTop);
            view.findViewById(R.id.day_picker_selected_date_layout_end).setBackgroundColor(mAccentColorTop);
    ...
    public void setStartDate(int year, int monthOfYear, int dayOfMonth,int yearEnd, int monthOfYearEnd, int dayOfMonthEnd) {
        mCalendar.set(Calendar.YEAR, year);
        mCalendar.set(Calendar.MONTH, monthOfYear);
        mCalendar.set(Calendar.DAY_OF_MONTH, dayOfMonth);
        mCalendarEnd.set(Calendar.YEAR, yearEnd);
     ...
     */
    public void setAccentColor(int accentColor, int accentColor2) {
        mAccentColor = accentColor;
        mAccentColorTop = accentColor2;
    }
