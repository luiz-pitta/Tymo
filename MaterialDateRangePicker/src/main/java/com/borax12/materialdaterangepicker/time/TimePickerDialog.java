...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public void setAccentColor(int color, int color2) {
        mAccentColor = color;
        mAccentColorTop = color2;
    }
    ...
    public void setStartTime(int hourOfDay, int minute, int hourOfDay2, int minute2) {
        mInitialHourOfDay = hourOfDay;
        mInitialMinute = minute;
        mInitialHourOfDayEnd = hourOfDay2;
        mInitialMinuteEnd = minute2;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSelectedColor = res.getColor(R.color.mdtp_deep_purple_400);
        mUnselectedColor = res.getColor(R.color.mdtp_deep_purple_200);
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            for (int i = 0; i < widget.getChildCount(); i++) {
                ...
                d.setColorFilter(getResources().getColor(R.color.mdtp_accent_color), PorterDuff.Mode.SRC_IN);
        ...
        if (mAccentColor != -1) {
            view.findViewById(R.id.time_display).setBackgroundColor(mAccentColorTop);
            view.findViewById(R.id.time_display_end).setBackgroundColor(mAccentColorTop);
        ...
        tabHost.setCurrentTab(initialPosition);
    ...
    /**
     * setCurrentTab
     * @param @int position of current tab
     */
