    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        buttonText1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString(FirebaseAnalytics.Param.ITEM_ID, "cancel" + "=>=" + getClass().getName().substring(20,getClass().getName().length() - 1));
        ...
        buttonText2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bundle bundle = new Bundle();
                bundle.putString(FirebaseAnalytics.Param.ITEM_ID, "confirm" + "=>=" + getClass().getName().substring(20,getClass().getName().length() - 1));
                bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE, "=>=" + getClass().getName().substring(20,getClass().getName().length() - 1));
                mFirebaseAnalytics.logEvent(FirebaseAnalytics.Event.SELECT_CONTENT, bundle);
                dialog.dismiss();
            }
