...
public class AddPart2Activity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener, View.OnClickListener, View.OnTouchListener, View.OnLongClickListener {
    ...
    private void setActivityInformation(long id, ActivityServer activityServer) {
        ...
        mSubscriptions.add(NetworkUtil.getRetrofit().getActivity2(id, activityServer)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(this::handleAddPart2Activity, this::handleError));
    }
    ...
    private void handleAddPart2Activity(Response response) {
        ...
        if (response.getTags().size() == 0) {
            ...
            if (!activityServer.getCubeIcon().matches("")) {
                ...
                Glide.with(AddPart2Activity.this)
        ...
        AddPart2Activity editActivity = this;
    ...
    private void createDialogSelectIcon() {
        ...
        customizeCleanButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_400));
                customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_400_light));
                if (activityWrapper != null) {
                    activityWrapper.getActivityServer().setCubeColor(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_400));
                    activityWrapper.getActivityServer().setCubeColorUpper(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_400_light));
                }
        ...
        customizeColorPicker.setColorListener(new ColorPickerView.ColorListener() {
            ...
            public void onColorSelected(int color) {
                ...
                if (first_open && (cubeUpperBoxIcon.getTag() != null || (activityWrapper != null && activityWrapper.getActivityServer().getCubeIcon().contains("http")))) {
                    ...
                    if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.red_A700)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.red_A700));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.red_A700_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.red_A700));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.red_A700_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.pink_400)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.pink_400));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.pink_400_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.pink_400));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.pink_400_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.pink_900)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.pink_900));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.pink_900_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.pink_900));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.pink_900_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.purple_500)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.purple_500));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.purple_500_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.purple_500));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.purple_500_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_400)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_400));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_400_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_400));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_400_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_800)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_800));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_800_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_800));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_800_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.blue_400)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_400));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_400_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_400));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_400_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.blue_800)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_800));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_800_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_800));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_800_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.cyan_400)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.cyan_400));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.cyan_400_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.cyan_400));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.cyan_400_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.cyan_800)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.cyan_800));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.cyan_800_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.cyan_800));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.cyan_800_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.green_400)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.green_400));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.green_400_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.green_400));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.green_400_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.lime_600)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.lime_600));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.lime_600_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.lime_600));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.lime_600_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.deep_orange_400)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_orange_400));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_orange_400_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_orange_400));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_orange_400_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.brown_400)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.brown_400));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.brown_400_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.brown_400));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.brown_400_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.brown_700)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.brown_700));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.brown_700_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.brown_700));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.brown_700_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.grey_500)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.grey_500));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.grey_500_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.grey_500));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.grey_500_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.blue_grey_500)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_grey_500));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_grey_500_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_grey_500));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_grey_500_light));
                    } else if (color == ContextCompat.getColor(AddPart2Activity.this, R.color.blue_grey_900)) {
                        customizeCubeLowerBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_grey_900));
                        customizeCubeUpperBoxIcon.setColorFilter(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_grey_900_light));
                        customizeCubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_grey_900));
                        customizeCubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.blue_grey_900_light));
                    }
                }
            }
        });
        ...
        if (activityWrapper == null || !activityWrapper.getActivityServer().getCubeIcon().contains("http")) {
            if (cubeUpperBoxIcon.getTag() == null) {
                urlIcon = Constants.IC_ADD_CUBE_URL;
                cubeLowerBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_400));
                cubeUpperBoxIcon.setTag(ContextCompat.getColor(AddPart2Activity.this, R.color.deep_purple_400_light));
            } else {
