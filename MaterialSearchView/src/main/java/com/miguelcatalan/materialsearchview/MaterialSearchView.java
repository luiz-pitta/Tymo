...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private PressBackViewListener mPressBackViewListener;
    private PressFilterViewListener mPressFilterViewListener;
    ...
    private final OnClickListener mOnClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (v == mBackBtn) {
                if (mPressBackViewListener != null && mPressBackViewListener.onPressBack()) {
                    closeSearch();
                }
            } else if (v == mVoiceBtn) {
                onVoiceClicked();
                ...
                if (mPressFilterViewListener != null)
                    mPressFilterViewListener.OnFilterPressed();
            }
        }
    };
    ...
    /**
     * Set this listener to listen to back press events.
     *
     * @param listener
     */
    public void setPressBackViewListener(PressBackViewListener listener) {
        mPressBackViewListener = listener;
    }

    /**
     * Set this listener to listen to filter press events.
     *
     * @param listener
     */
    public void setPressFilterViewListener(PressFilterViewListener listener) {
        mPressFilterViewListener = listener;
    }
    ...
    public interface PressBackViewListener {
        boolean onPressBack();
    }

    public interface PressFilterViewListener {
