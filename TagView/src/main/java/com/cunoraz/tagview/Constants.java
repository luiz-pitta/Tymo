...
public class Constants {
	...
	public static final int DEFAULT_TAG_LAYOUT_COLOR = Color.parseColor("#7E57C2");
	public static final int DEFAULT_TAG_LAYOUT_COLOR_PRESS = Color.parseColor("#9575CD");
